...
fs, audio = read("project-one\SampleAudioWav\Highest C.wav")
...
plt.xlabel('Time [s]')
plt.ylim(0, 10000)  # Focus on piano note range
plt.legend()
plt.tight_layout()
plt.show()

# find peaks
time_target = 1.5 # Adjust this to the desired time in seconds
